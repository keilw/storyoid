...
package us.catmedia.storyoid.view.notepad;

import static us.catmedia.storyoid.model.NotePad.Notes;

import us.catmedia.storyoid.R;
import us.catmedia.storyoid.model.NotePad;
...
public class TitleEditor extends Activity implements View.OnClickListener {
	private static final String TAG = Constants.APP_NAME_SHORT + ".Title";
	
    /**
     * This is a special intent action that means "edit the title of a note".
     */
    public static final String EDIT_TITLE_ACTION = "us.catmedia.storyoid.view.notepad.action.EDIT_TITLE";
